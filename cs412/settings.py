...
SECRET_KEY = 'django-insecure-g98i(-uhm4mad!$m16%4&c#^w_$90vdz2q9j-hqq!o+_7rfe^b'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Added for static files management
